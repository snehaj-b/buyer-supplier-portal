...
const SubmitProposal = () => {
  ...
  const handleTermChange = (id: number, field: string, value: string) => {
  ...
  return (
    <div className="page-container">
      <h1 className="text-2xl font-semibold text-gray-800 mb-6">Submit Proposal</h1>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to submit this proposal? Once submitted, you cannot make changes unless the purchaser requests a new version.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
